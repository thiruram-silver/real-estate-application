...
module.exports = function(app) {
  app.get('/looking-for', isLoggedIn, function(req, res, next) {
    res.render('looking-for.ejs', {title: "Buyer Details" });
  });

  app.post('/looking-for', isLoggedIn, function(req, res, next) {
